...
\setlength{\itemsep}{-1ex}
   \item Problem 1
   \item Set up
   \item Model 1 - years in education on life satisfaction
   \item Model 2 - gross domestic product on life satisfaction
   \item Model 3 - years in education and gdp on life satisfaction (multinomial)
   \item Problem 2
   \item Functions
\end{itemize}
...
\subsection*{Model 1 - years in education on life satisfaction}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Undefined function or variable 'data'.

Error in hw3 (line 16)
A = [ones(1,11)' data(:,1)];
\end{verbatim} \color{black}
    

\subsection*{Model 2 - gross domestic product on life satisfaction}
...
\subsection*{Model 3 - years in education and gdp on life satisfaction (multinomial)}
